@pluginIsInstalled @javascript @resetSession @baseScenarios @configuration @6.4
Feature: Configuration
  ...
  Scenario: Setup sandbox keys and synchronize
    ...
    And I click on CSS locator "button.payever-extension-config-button"
    And I wait till element exists "button.payever-extension-config-button"
    ...
    And I click on CSS locator "button.sw-extension-config__save-action"
