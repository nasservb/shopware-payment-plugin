@pluginIsEnabled @setupPaymentMethods @javascript @resetSession @payments @6.1
Feature: Conditions
  ...
  Scenario Outline: Hide after failed payment attempt
    ...
    When I click on CSS locator "#confirmPaymentForm button.btn.btn-primary"
    ...
    Then I should see "Unfortunately, something went wrong"
    Given I am on stub product page
    And I select product quantity <qty>
    And I press "Add to shopping cart"
    And I wait till I see "Shopping cart"
    And I am on "/checkout/confirm"
    Then I should see element with the following CSS locator ".confirm-payment-current.is-invalid"
