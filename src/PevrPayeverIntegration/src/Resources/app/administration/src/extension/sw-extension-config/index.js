...
Component.override('sw-meteor-page', {
    ...
    inject: ['PayeverPaymentService', 'PayeverPluginService', 'systemConfigApiService'],
    ...
    methods: {
        notify() {
            this.PayeverPluginService.getNotifications()
                .then((response) => {
        ...
        onSync() {
            this.isLoading = true;
            this.PayeverPaymentService.synchronize()
                .then((response) => {
        ...
        downloadLog(e) {
            this.PayeverPluginService.openLog()
                .then((response) => {
                    if (response.data) {
